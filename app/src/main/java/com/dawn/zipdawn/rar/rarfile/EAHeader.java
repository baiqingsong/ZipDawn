 ...
 * "@":  "&#064;" 
 */
package com.dawn.zipdawn.rar.rarfile;


import com.dawn.zipdawn.rar.io.Raw;
...
//	private Log logger = LogFactory.getLog(getClass());
    ...
    public void print() {
        super.print();
        System.out.print("unpSize: " + unpSize);
        System.out.print("unpVersion: " + unpVer);
        System.out.print("method: " + method);
        System.out.print("EACRC:" + EACRC);
    }
}
